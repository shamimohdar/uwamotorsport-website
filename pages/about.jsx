  ...
  return (
    <>
      ...
      <div className=' w-8/12 h-full mx-auto justify-center items-center lg:text-center text-justify'>
        <p className='py-2 text-gray-700 dark:text-white text-lg'>
      ...
      <div className=' w-8/12 m-auto gap-8 text-2xl font-bold pb-5'>
        <p className='lg:block hidden py-2 text-gray-700 dark:text-white text-center lg:pb-0 pb-6'>
      ...
      <div className='xl:w-8/12 m-auto xl:grid grid-cols-3 py-10'>
        ...
        <div className='col-span-1 xl:w-full w-8/12 mx-auto xl:py-0 text-justify'>
          <p className='pb-2 text-gray-900 dark:text-white text-2xl font-bold'>
            Who are we?
          </p>
          ...
          <div className='lg:grid grid-cols-3 gap-16 lg:pb-16'>
            ...
            <div className='col-span-1 w-full h-auto m-auto shadow-gray-400 py-5'>
              ...
              <Image src={TomImg} alt='/' />
                ...
                <div className='pt-10 text-gray-900 dark:text-white text-3xl font-bold text-left'>
                <p>Thomas Webb</p>
              </div>
              <div className='py-2 text-gray-900 dark:text-white text-2xl pb-10 text-left'>
                <p>Project Manager</p>
              </div>
            </div>
          </div>
